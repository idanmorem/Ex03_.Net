...
namespace Ex03.GarageLogic
{
     ...
     {
          private readonly Dictionary<string, GarageLogic.Vehicle> r_VehiclesInGarage;
          private readonly VehicleFactory r_Factory;

          public GarageLogicC()
          {
               r_VehiclesInGarage = new Dictionary<string, GarageLogic.Vehicle>();
          ...
          public void AddVehicle(GarageLogic.Vehicle i_Vehicle, string i_LicenseNumber)
          {
               r_VehiclesInGarage.Add(i_LicenseNumber, i_Vehicle);
          }

          public float GetMaxAirPressure(GarageLogic.Vehicle i_Vehicle)
          {
               return i_Vehicle.Wheels[0].MaxAirPressure;
          }

          public void AddEngine(GarageLogic.Vehicle i_Vehicle, Engine.eEngineType i_Type)
          {
               r_Factory.AddEngine(i_Vehicle, i_Type);
          }

          public void AddPrecentage(GarageLogic.Vehicle i_Vehicle, float i_input)
          {
          ...
          //func no. 1
          public GarageLogic.Vehicle CreateVehicle(GarageLogic.Vehicle.eVehicleType i_Type)
          {
          ...
          {
               GarageLogic.Vehicle currentVehicle;
          ...
          public void AddWheels(GarageLogic.Vehicle i_Vehicle, string i_ManufacturerName, float i_CurrentAirPressure)
          {
          ...
          public void AddSingleWheel(GarageLogic.Vehicle i_Vehicle, string i_ManufacturerName, float i_CurrentAirPressure, int i_index)
          {
        ...
        public void ChangeStatus(string i_VehicleLicensePlate, GarageLogic.Vehicle.eVehicleStatus i_NewStatus)
        {
             GarageLogic.Vehicle currentVehicle = r_VehiclesInGarage[i_VehicleLicensePlate];
             currentVehicle.Status = i_NewStatus;
             }


            public Dictionary<string, GarageLogic.Vehicle>.KeyCollection GetPlateList()
          {
               return r_VehiclesInGarage.Keys;
          }

        public GarageLogic.Vehicle.eVehicleStatus getVehicleState(string i_VehicleLicensePlate)
        {
             GarageLogic.Vehicle currentVehicle;
        ...
        // public Vehicle GetVehicleBundle(string i_VehicleLicensePlate)
        // {
        //      GarageLogic.Vehicle currentVehicle;
        //      r_VehiclesInGarage.TryGetValue(i_VehicleLicensePlate, out currentVehicle);
        //      return new Vehicle(currentVehicle, i_VehicleLicensePlate);
        //      }
        ...
        //        }
        //
        //        private GarageLogic.Vehicle.eVehicleStatus m_Status;
        //        public GarageLogic.Vehicle.eVehicleStatus Status
        //        {
        //             get => m_Status;
        //             set => m_Status = value;
        //        }
        ...
        //
        //
        //        public Vehicle(GarageLogic.Vehicle i_Vehicle, string i_ID)
        //        {
        ...
        //   }
        //
          public void setValueForUniqueProperty(PropertyInfo i_UniquePropertyInfo, GarageLogic.Vehicle i_NewVehicle, string i_NewPropertyValue)
          {
        ...
        public List<PropertyInfo> GetVehiclesUniqueProperties(GarageLogic.Vehicle i_NewVehicle)
          {
               ...
               foreach (PropertyInfo currentCheckedProperty in allProperties)
               {
                    ...
                    if (typeof(GarageLogic.Vehicle).GetProperty(checkedPropertyName) == null) //if vehicle doesn't have this propery, it's unique.
                    {
